-- Import hardcoded Armal blog posts into Supabase CMS as drafts.
-- Run this in Supabase Dashboard > SQL Editor.
-- Nothing becomes public because every row is saved with status = 'draft'.
--
-- Note about images:
-- cover_image_url is intentionally null. Upload cover images later through the admin panel
-- so the URLs point to Supabase Storage instead of local Vite source assets.
